...
class Page < ApplicationRecord
  ...
  private
    def prompt
      ...
      また、
      - 「Tier4」は仕事のことです。
      - 趣味カテゴリには、読書、絵を描く, tokimetri開発, お菓子作り, ゲーム(ソシャゲ以外), ブログ執筆などが含まれます。
      - 娯楽/だらだらカテゴリには、ぼーっとする、ネットサーフィン、YouTube、ソシャゲなどが含まれます。
      ...
      「15:45までネットサーフィン。
        16:06まで留学書類書く。
        16:46まで研究する。うち20分ぐらいネットサーフィン。
      」は、
      {"start": "（適当な時刻）", "end": "2025-12-15 15:45", "what": "ネットサーフィン", "category": "趣味"},
      {"start": "2025-12-15 15:45", "end": "2025-12-15 16:06", "what": "留学書類書く", "category": "事務"},
      {"start": "2025-12-15 16:06", "end": "2025-12-15 16:26", "what": "研究する", "category": "研究"},
      {"start": "2025-12-15 16:26", "end": "2025-12-15 16:46", "what": "ネットサーフィン", "category": "趣味"}
      のように出力してください。
